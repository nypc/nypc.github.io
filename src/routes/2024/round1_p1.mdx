...
<div style={{ display: "flex" }}>
  <Figure src="/2023/1-1.6a31bfc92fee281a.png" width={1000} />
</div>
...
주어진 $N$ 개의 문자열을 담고 있는 배열에서, $K$ 개의 문자열을 찾아 제거하는 작업을 구현하면 충분하다. 혹은, 각 $N$ 개의 문자열이 $K$ 개의 문자열 중 하나인지를 판별하는 함수를 작성하여 구현할 수도 있다.
