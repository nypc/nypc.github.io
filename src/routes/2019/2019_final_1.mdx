...
원래 문장과 치환된 문장을 대조하여 한 문자가 두 종류 이상의 문자로 치환되었는지 등을 확인하여 치환표에 이상이 있는지 제일 먼저 확인한다. 이상이 없을 경우 등장만 알파벳 종류 수를 $c$개라고 했을 때, 답은 $2\times 3\times\cdots\times(26-c)$가 된다.
