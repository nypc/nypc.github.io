...
export const Route = createFileRoute("/en/$year/replay/$page")({
  params: {
    parse: z.object({
  ...
  loader: ({ params }) => {
    const path = `${params.year}/replay/${params.page}`;
    const post = allPosts.find((p) => p.slug === `en/${params.year}/replay/${params.page}`);
