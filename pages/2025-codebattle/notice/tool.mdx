...
<LanguageExample name="Python3" example="py3" />
<LanguageExample name="Pypy3" example="py3" />
<LanguageExample name="Java 21" example="java" />
<LanguageExample name="Rust 2024" example="rust" />
<LanguageExample name="Node.js" example="js" />
<LanguageExample name="Typescript 5.8.3" example="js" />
...
<LanguageExample name="Kotlin JVM 2.1" example="kt" />
