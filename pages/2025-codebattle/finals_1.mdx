...
버섯의 성에 도착한 예티와 핑크빈은 다양한 색과 문양의 버섯을 보게되었습니다. 예티는 버섯을 같은 모양끼리 핑크빈은 버섯을 같은 색끼리 모으고 싶어했습니다. 
...
게임 보드는 위와 같은 모양으로, 총 $64$개의 칸으로 이루어져있습니다. 각 보드의 좌표는 (열, 행, 부호)의 순서쌍으로 나타낼 수 있습니다.
...
예를 들어, `c5-`은 `c5+`, `b5+`, `c4+`과 연결되어 있고, `f4+`은 `f4-`, `f5-`와 연결되어있습니다.
...
- 위 3가지 방법에 해당하지 않는 두 타일은 간접 연결되어있지 않습니다.
</aside>
