...
* `일반` - 테스트케이스 종류별로 요구하는 조건을 정확히 만족시켜야만 해당 테스트케이스가 맞은 것으로 간주되는 문제입니다. 결과 파일만 제출해도 되는 문제가 있으니 유의해주시길 바랍니다.
...
코드를 제출하기 전, 로컬 환경에서 편한 개발 도구를 사용하여 얼마든지 테스트해도 무방합니다. 다만 실행 및 채점 환경이 다를 수 있으므로, 불이익을 최대한 방지하기 위해서 <a href='https://nypc.github.io/2018/notice/tool.html' target='_blank'>[개발 도구 사용 안내]</a> 를 꼭 읽어보시기 바랍니다 (특히 Visual Studio / Visual C++ 사용시).
