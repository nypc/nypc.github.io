...
* ![PARTIAL](./image/change_history.png) `PARTIAL` - Partial Score. 프로그램이 정상적으로 종료하였고, 출력한 답이 부분 점수를 획득한 경우입니다. (부분 점수를 획득할 수 있는 문제의 경우 문제 채점 규칙 설명에 명시됩니다.)
* ![OK](./image/done.png) `OK` - OK. 프로그램이 정상적으로 종료하였고, 출력한 답이 정답인 경우입니다.
