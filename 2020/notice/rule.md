...
제출이 완료되면 자동 채점이 시작되고, 자동 채점이 끝난 후 `마지막 채점 결과` 페이지에서 제출 내역과 결과를 확인할 수 있습니다. 여러 번 답을 제출할 수 있으며, **마지막 제출한 답이 최종 평가 기준이 됩니다.**

각 문제에 대한 점수는 double 자료형에 저장되고, 출력 시 반올림되어 소수점 둘째 자리까지 표시됩니다.
